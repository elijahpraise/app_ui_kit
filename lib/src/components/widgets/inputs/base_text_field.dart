...
class BaseTextField extends StatelessWidget {
  ...
  /// Formatter for input: customize how you want the input to appear
  ...
  Widget build(BuildContext context) {
    ...
    final effectiveBorderRadius = BorderRadius.circular(borderRadius ?? 6);
    ...
    return TextFormField(
      ...
      style:
          textStyle ??
          inputTheme.labelStyle?.copyWith(color: theme.colorScheme.onSurface),
